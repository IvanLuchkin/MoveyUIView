...
public class SavedMoviesView {
    ...
    public SavedMoviesView(InfinitePlaceHolderView loadMoreView, List<BaseMovie> feedList) {
    ...
    class ForcedWaitedLoading implements Runnable {
        ...
        public void run() {
            ...
            new Handler(Looper.getMainLooper()).post(() -> {
                ...
                for (int i = count - 1;
                     i < (count - 1 + SavedMoviesView.LOAD_VIEW_SET_COUNT) && mFeedList.size() > i;
                     i++) {
